...
{{--@dd($errors->has('title'));--}}
        <div id="vertical-form" class="p-5">
            <div class="preview">
                ...
                <div class="mt-3">
                    <label for="vertical-form-2" class="form-label">Description Ar</label>
                    <input id="vertical-form-2" class="form-control" type="file" name="logo"></input>
                </div>
                @error('logo')
                <div class="error">{{ $message }}</div>
                @enderror
                ...
                <div class="mt-3">
                    ...
                    <div class="flex flex-col sm:flex-row mt-2">
                        <div class="form-check mr-2">
                            <input id="checkbox-switch-{{$country->id}}" class="form-check-input" type="checkbox" value="{{$country->id}}" name="country[]">
