            ...
            <div id="vertical-form" class="p-5">
                <div class="preview">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea id="vertical-form-2" class="form-control" name="description">{{ old('description') }}</textarea>
                    </div>

                    <div class="mt-3">
                        <label for="vertical-form-2" class="form-label">Description Ar</label>
                        <textarea id="vertical-form-2" class="form-control" name="description_ar">{{ old('description_ar') }}</textarea>
                    </div>
